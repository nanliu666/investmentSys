...
const MODULE = process.env.MODULE_ENV || 'home'
// 入口模板路径
...
module.exports = {
  dev: {
    ...
    // host: '192.168.43.171', // 自己手机wifi IP地址
    // host: '192.168.1.102', // 家 IP地址
    // host: '10.122.10.59', // 连接公司网线
    host: '192.168.0.180', // 连接公司wifi
    ...
    proxyTable: {
      '/api': {  //用来对接兵哥跨域
        target: 'http://gz.ifca.com.cn:9999/ydzs/',
        changeOrigin: true,
        pathRewrite: {
          '^/api': ''
        }
  ...
  build: {
    ...
    assetsRoot: process.env.MODE_ENV === 'separate' ? path.resolve(__dirname, '../dist', MODULE) : path.resolve(__dirname, '../dist', MODULE),
    assetsSubDirectory: 'static',
